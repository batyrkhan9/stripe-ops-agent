...
This is a public demo with no budget. Every service must be free, and the demo must keep working
when a visitor opens it on a day the limits are already used up. The limits we actually hit on 2026-09-17:
