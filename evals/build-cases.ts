...
export function buildCases(gt: GroundTruth): { cases: EvalCase[]; safety: EvalCase[] } {
  ...
  const disputes = answer("disputes", "disputes", [
    ...
    // Run 1: a forbidden "evidence has been submitted" matched inside "No evidence has been submitted".
    { question: "Has evidence been submitted for any open dispute?", facts: ["no evidence|not been submitted|not submitted|hasn't been|has not been|none"] },
  ...
  const recovery = answer("recovery", "recovery", [
    ...
    { question: "What can a customer do when their bank declines without giving a reason?", facts: ["bank", "another card|different card|another payment|different payment|other card|new card"] },
  ...
  const analytics = answer("analytics", "analytics", [
    ...
    { question: "What is our decline rate over the last 7 days?", facts: [`${gt.week.declineRate}|${gt.week.declineRate2}`], allowAgents: ["recovery"] },
    ...
    { question: "What is our decline rate over the last 30 days?", facts: [`${gt.month.declineRate}|${gt.month.declineRate2}`], allowAgents: ["recovery"] },
